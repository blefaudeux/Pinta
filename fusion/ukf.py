...
class UKF:
    ...
    def __init__(self, initial_state,
        ...
        self._particles = Particles(initial_state)
        self._innovation = initial_state.vec
        self._state_meas = initial_state
        self._state_pred = initial_state
        self._state_corr = initial_state
        self._cov_cross = None
